...
public class AshrakatStep2TypeEffect : MonoBehaviour
{
[TextArea]
...
//      private void Awake()
  //  {
    ...
    void Start()
    {
        ...
        Invoke("increaseCharacterInterval", 1.2f);
        Invoke("DecreaseCharacterInterval", 1.7f);
        Invoke("DecreaseCharacterInterval", 1.9f);
        Invoke("DecreaseCharacterInterval", 2.2f);
        m_label.text = m_text;
        m_partialText = "";
