...
public class AqwaFullTypeEffect : MonoBehaviour
{
    [TextArea]
...
//      private void Awake()
  //  {
    ...
    void Start()
    {
        ...
        Invoke("DecreaseCharacterInterval", 14.1f);
        Invoke("increaseCharacterInterval", 15.3f);
        Invoke("increaseCharacterInterval", 16.8f);
        Invoke("increaseCharacterInterval", 17.1f);
        Invoke("increaseCharacterInterval", 17.8f);
        Invoke("increaseCharacterInterval", 18.1f);
        Invoke("increaseCharacterInterval", 19.1f);
        Invoke("DecreaseCharacterInterval", 22.5f);
        Invoke("DecreaseCharacterInterval", 24.2f);
        Invoke("DecreaseCharacterInterval", 25.2f);
        Invoke("DecreaseCharacterInterval", 25.1f);
        Invoke("DecreaseCharacterInterval", 26.2f);
        m_label.text = m_text;
        m_partialText = "";
