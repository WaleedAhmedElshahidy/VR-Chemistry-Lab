...
public class HanaStep1TypeEffect : MonoBehaviour
{
[TextArea]
...
//      private void Awake()
  //  {
    ...
    void Start()
    {
        Invoke("increaseCharacterInterval", 0.5f);
        Invoke("increaseCharacterInterval", 1.5f);
        Invoke("DecreaseCharacterInterval", 3.8f);
        Invoke("DecreaseCharacterInterval", 5.1f);
        Invoke("DecreaseCharacterInterval", 4.5f);
        Invoke("DecreaseCharacterInterval", 4.8f);
